'''
Solving the MountainCar Environment with Deep Q-learning
...
class DeepQLearning:
    def __init__ (self, n_actions, model):
        ...
        self.epsilon_decay = 0.995 #exploration rate decreases by this every iteration
...
if __name__ == '__main__':
    ...
    for episode in range(episodes):
        ...
        for time in range(max_time):
            ...
            reward = reward if not done else -10 #lowers score if game is over)
