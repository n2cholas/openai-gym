'''
Solving the Pendulum Environment with Deep Q-learning
...
class DeepQLearning:
    def __init__ (self, n_actions, model):
        ...
        self.epsilon_decay = 0.999 #exploration rate decreases by this every iteration
...
if __name__ == '__main__':
    ...
    for episode in range(episodes):
        ...
        for time in range(max_time):
            ...
            if done:
                print("episode: {}/{}, score: {:.2}, reward: {:.2}, epsilon: {:.2}".format(episode, episodes, score, reward, dqn.epsilon))
                break
